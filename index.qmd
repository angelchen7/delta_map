...
pal.themes.2 <- colorNumeric(palette = c("lightblue", "steelblue", "mediumblue"),
                           domain = c(-1, 1))

pal.themes.3 <- colorNumeric(palette = c("pink", "hotpink", "maroon"),
                           domain = c(-1, 1))

pal.themes.4 <- colorNumeric(palette = c("thistle", "orchid", "purple"),
                           domain = c(-1, 1))

pal.themes.5 <- colorNumeric(palette = c("gold", "orange", "orangered"),
                           domain = c(-1, 1))
...
leaflet() %>%
  ...
  addPolygons(group = "Socio-economic Status", data = svi_delta,
              color = "gray", fillColor = ~pal.themes.1(RPL_THEME1), weight = 1, fillOpacity = .8,
              label = ~htmlEscape(paste("Socio-economic status:", RPL_THEME1))) %>%
  addPolygons(group = "Household Characteristics", data = svi_delta,
              color = "gray", fillColor = ~pal.themes.2(RPL_THEME2), weight = 1, fillOpacity = .8,
              label = ~htmlEscape(paste("Household characteristics:", RPL_THEME2))) %>%
  addPolygons(group = "Racial & Ethnic Minority Status", data = svi_delta,
              color = "gray", fillColor = ~pal.themes.3(RPL_THEME3), weight = 1, fillOpacity = .8,
              label = ~htmlEscape(paste("Racial & ethnic minority status:", RPL_THEME3))) %>%
  addPolygons(group = "Housing Type & Transportation", data = svi_delta,
              color = "gray", fillColor = ~pal.themes.4(RPL_THEME4), weight = 1, fillOpacity = .8,
              label = ~htmlEscape(paste("Housing type & transportation:", RPL_THEME4))) %>%
  addPolygons(group = "Overall Vulnerability", data = svi_delta,
              color = "gray", fillColor = ~pal.themes.5(RPL_THEMES), weight = 1, fillOpacity = .8,
              label = ~htmlEscape(paste("Overall vulnerability:", RPL_THEMES))) %>%
...
Model-based estimate for crude prevalence of frequent mental distress among adults, 2022:", mhlth_crud))) %>%
  ...
  addLayersControl(
    ...
    overlayGroups = c("Socio-economic Status",
  ...
  hideGroup(c("Socio-economic Status",
              "Household Characteristics",
              "Racial & Ethnic Minority Status",
              "Housing Type & Transportation",
              "Overall Vulnerability",
